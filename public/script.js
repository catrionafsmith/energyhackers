...
if (emailButton) {
    emailButton.addEventListener('click', async () => {
        ...
        // console.log(text)
        const prompt = `you are a helpful and positive bot with a friendly tone who gives information about a user's carbon footprint at an event in central london. I say that I walked to this event, and brought a reusable coffee cup with me and am a vegetarian. You reply to give me a carbon score (out of 10) and some advice about how I can reduce my environmental impact further:`
        // console.log(prompt)
